...
public class memberController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(url.contains("addMember.do")) {
			...
			File uploadDir = new File(member.common.Constants.UPLOAD_PATH);	// upload할 폴더
			...
			MultipartRequest multi = new MultipartRequest(	// request 기능+파일 업로드 기능
					...
					member.common.Constants.UPLOAD_PATH, 	// 업로드 할 몰더 경로
					member.common.Constants.MAX_UPLOAD, 	// 업로드 할 파일 용량 제한
					"utf-8", 	// 한글 인코딩
